#
# Sphinx configuration for aiida-dftbplus
#
...
html_use_opensearch = "https://aiida-dftbplus.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "src", "aiida_dftbplus")
